...
export default function FriendCard({ friend, isDarkMode = false }: FriendCardProps) {
  ...
  const builderData = {
    ...
    bio: friend.bio || "Passionate developer focused on creating intuitive user experiences and scalable applications.",
    roles: friend.role ? [friend.role, "Developer"] : ["Developer", "Member"],
    lookingFor: ["Collaboration", "Mentorship"],
    location: friend.location || "Nairobi, Kenya",
    avatar: friend.profilePicture || friend.avatar || null
  };
